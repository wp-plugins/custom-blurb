<?php 
/**********************************************************************************************************************
File: 			plugins/qs-custom-story/widget/templates/rollover.php
Description: 	Quadshot - Custom Story Widget News Template
Version: 		1.0
Author: 		Loushou
License: 		GPL2
Text Domain: 	qs-custom-story-list-widget
...
?>
<div class="rollover-overlay-blurb">
                ...
                <?php if ((isset($post->thumb) && !empty($post->thumb)) || (isset($post->thumb_URL) && !empty($post->thumb_URL))) {  ?>
					...
					?>
                        <li class="blurb-post-with-thumb blurb-post-<?php echo $i; ?>">
                            ...
                            <div class="blurb-valign-fix-image">
                            	<div id="blurb-rollover-<?php echo $post->ID; ?>" class="blurb-rollover" title="<?php echo $post_title ?>">
                                	<a href="<?php echo get_permalink($post->ID) ?>" title="Read More" class="blurb-image-keyhole blurb-<?php echo $thumb_width ?>x<?php echo $thumb_height ?>-keyhole"><?php echo $imgSrc ?></a>
                                </div>

                                <div id="blurb-overlay-<?php echo $post->ID; ?>" class="blurb-overlay" title="<?php echo $post_title ?>">
