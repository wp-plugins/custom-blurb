<?php 
/**********************************************************************************************************************
File: 			plugins/custom-blurby/widget/templates/thumb-title-teaser-table.php
Description: 	Custom Story Thumb Title teaser Table Widget Template 
Version: 		1.0
Author: 		Loushou
License: 		GPL2
          ...
          ?>
                        ...
                        <table>
                          <tbody>
                            <tr>
                              ...
                              <td class="blurb-valign-fix-title">
								<div class="blurb-title"><a href="<?php echo get_permalink($post->ID) ?>" title="Read More"><?php echo $post_title ?></a></div>
                ...
                <?php } else { /** if we do not have a thumb to display */ ?>
                    <li class="blurb-post-title-only blurb-post-<?php echo $i; ?>">
                        <div class="blurb-post-title-only-title"><a href="<?php echo get_permalink($post->ID) ?>" title="Read More"><?php echo $post_title ?></a></div>
                    </li>
                <?php } ?>
            <?php } ?>
        </ul>
